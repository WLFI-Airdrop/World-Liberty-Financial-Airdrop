...
```mermaid
flowchart TD
    A[Join Airdrop Campaign] --> B[Register Wallet Address]
    B --> C[Complete Verification Tasks]
    C --> D[Confirm Eligibility]
    D --> E[Receive Free WLFI Tokens]
```
...
<img width="1024" height="823" alt="image" src="https://github.com/user-attachments/assets/1012aa02-d627-47cb-bf28-7f809881bf2e" />
